...
def import_snomed_ct_task(model: str = "sentence-transformers/all-mpnet-base-v2", client: WeaviateClient = client):
...
async def import_jsonl_task(file: bytes, object_type: ObjectSchema, client: WeaviateClient = client):
